...
const DEFAULT_WIDGETS = [
  ...
  { id: 'orders',      label: 'Active Sales Orders',    type: 'stat',  enabled: true, order: 4, size: 1 },
  { id: 'low-stock',   label: 'Low Stock Alerts',       type: 'stat',  enabled: true, order: 5, size: 1 },
  { id: 'production',  label: 'In Production',          type: 'stat',  enabled: true, order: 6, size: 1 },
  { id: 'total-emp',   label: 'Total Employees',        type: 'stat',  enabled: true, order: 7, size: 1 },
  ...
  { id: 'bar-chart',   label: 'Top Products',           type: 'chart', enabled: true, order: 10, size: 1 },
  { id: 'recent-txn',  label: 'Recent Transactions',    type: 'list',  enabled: true, order: 11, size: 1 },
  { id: 'overdue-inv', label: 'Overdue Invoices',       type: 'list',  enabled: true, order: 12, size: 1 },
  { id: 'recent-exp',  label: 'Recent Expenses',        type: 'list',  enabled: true, order: 13, size: 1 },
  { id: 'quotes',      label: 'Pending Quotations',     type: 'list',  enabled: false, order: 14, size: 1 },
];
